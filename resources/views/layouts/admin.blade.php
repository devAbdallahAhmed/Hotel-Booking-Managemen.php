...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="#">Vacation Rental</a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <ul class="navbar-nav side-nav" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('all.hotel')}}" style="margin-left: 20px;">Hotels</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('all.rome')}}" style="margin-left: 20px;">Rooms</a>
                    </li>
                    <li class="nav-item">
